...
import assignment.nagarro.testCases.TC003_Mobile_FileLogo;
 ...
 * @since 2021-04-29
 */
public class FileLogoPage extends TC003_Mobile_FileLogo {
	...
	public FileLogoPage(@SuppressWarnings("rawtypes") AndroidDriver driver) {
		this.driver = driver;
