package mobileAssignment.nagarro.basics;
...
import assignment.nagarro.testCases.TC005_Mobile_Basics;
 ...
 * @since 2021-04-29
 */
public class Basics extends TC005_Mobile_Basics {
	...
	public Basics(@SuppressWarnings("rawtypes") AndroidDriver driver) {
		this.driver = driver;
