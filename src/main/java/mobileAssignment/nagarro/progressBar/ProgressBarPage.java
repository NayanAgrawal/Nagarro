...
import assignment.nagarro.testCases.TC004_Mobile_ProgressBar;
 ...
 * @since 2021-04-29
 */
public class ProgressBarPage extends TC004_Mobile_ProgressBar {
	...
	public ProgressBarPage(@SuppressWarnings("rawtypes") AndroidDriver driver) {
		this.driver = driver;
